package baguchi.pizza_guy_move.client;// Save this class in your mod and generate all required imports
...
public class PlayerAnimations {
    public static final AnimationDefinition mach_run = AnimationDefinition.Builder.withLength(0.5F).looping()
    ...
    public static final AnimationDefinition wall_mach_run = AnimationDefinition.Builder.withLength(0.5F).looping()
            .addAnimation("right_arm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(28.4676F, 0.4246F, 169.3489F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.125F, KeyframeAnimations.degreeVec(-14.821F, 7.87F, 163.9136F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.25F, KeyframeAnimations.degreeVec(-14.821F, 7.87F, 163.9136F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.5F, KeyframeAnimations.degreeVec(28.4676F, 0.4246F, 169.3489F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            ...
            .addAnimation("left_arm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(0.25F, KeyframeAnimations.degreeVec(26.3346F, -11.2286F, 191.6063F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.375F, KeyframeAnimations.degreeVec(-10.1698F, 13.3668F, 188.744F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.5F, KeyframeAnimations.degreeVec(-10.1698F, 13.3668F, 188.744F), AnimationChannel.Interpolations.CATMULLROM)
            ))
